...
const ClockLoader = () => (
  <div className="relative flex items-center justify-center w-24 h-24 mb-6">
      ...
      <svg className="absolute inset-0 w-full h-full animate-[spin_12s_linear_infinite] opacity-30" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="48" fill="none" stroke="currentColor" strokeWidth="1" className="text-zinc-200" strokeDasharray="4 8" />
      </svg>

      {/* Middle Ring - Reverse Spin */}
       <svg className="absolute inset-2 w-[calc(100%-16px)] h-[calc(100%-16px)] animate-[spin_6s_linear_infinite_reverse] opacity-50" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="48" fill="none" stroke="currentColor" strokeWidth="1" className="text-blue-500" strokeDasharray="30 150" strokeLinecap="round" />
      </svg>

      {/* Clock Face */}
      <div className="relative w-14 h-14 bg-zinc-900/90 rounded-full border border-zinc-700 shadow-[inset_0_0_15px_rgba(0,0,0,0.8)] flex items-center justify-center z-10 backdrop-blur-sm">
         <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-zinc-800 to-zinc-900 opacity-50"></div>
         
         {/* Center Pin */}
         <div className="absolute w-2 h-2 bg-blue-400 rounded-full z-20 shadow-[0_0_8px_rgba(59,130,246,1)] border border-zinc-900"></div>
         
         {/* Hour Hand */}
         <div className="absolute top-1/2 left-1/2 w-1 h-4 bg-zinc-400 origin-[50%_100%] -translate-x-1/2 -translate-y-full animate-[spin_4s_linear_infinite] rounded-full z-10 shadow-lg"></div>
         
         {/* Minute Hand */}
         <div className="absolute top-1/2 left-1/2 w-0.5 h-6 bg-blue-500 origin-[50%_100%] -translate-x-1/2 -translate-y-full animate-[spin_0.8s_linear_infinite] shadow-[0_0_4px_rgba(59,130,246,0.6)] rounded-full z-10"></div>
      </div>
  </div>
);

const HumorousLoaderMessages = () => {
    const messages = [
        "Just a minute...",
        "Teaching pixels how to behave...",
        "Convincing the AI this isn't abstract art...",
        "Deciphering your masterpiece...",
        "Aligning div tags with cosmic energy...",
        "Consulting the design gods...",
        "Adding polish and pizzazz...",
        "Locating the 'Make it Pop' button...",
        "Generating bugs... wait, no, features...",
        "Formatting chaos into code...",
    ...
    return (
        <div className="h-6 flex items-center justify-center relative overflow-hidden w-full">
            <p key={msgIndex} className="text-zinc-500 text-sm animate-[pulse_1s_ease-in-out_infinite] text-center w-full px-4 truncate">
                {messages[msgIndex]}
            </p>
        </div>
    );
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 w-full">
             ...
             <div className="w-full max-w-md space-y-8 flex flex-col items-center">
                ...
                <div className="flex flex-col items-center text-center">
                    <h3 className="text-zinc-100 font-mono text-lg tracking-tight mb-1">Constructing Environment</h3>
                    <HumorousLoaderMessages />
                </div>
                ...
                <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden mt-4">
                 ...
                 {/* Terminal Steps */}
                 <div className="border border-zinc-800 bg-black/50 rounded-lg p-4 space-y-3 font-mono text-sm w-full">
